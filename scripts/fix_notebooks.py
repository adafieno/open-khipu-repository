...
# Cell 9: Remove redundant import
nb1['cells'][8]['source'] = [
    ...
    '        stat, pval = mannwhitneyu(data_a[feature].dropna(), data_b[feature].dropna())\n',
